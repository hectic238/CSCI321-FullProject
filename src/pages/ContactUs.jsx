                ...
                >
                    ...
                    >
                        ...
                        <Typography variant="body1" color={darkMode ? "#cccccc" : "#666666"} sx={{ maxWidth: 700, mx: "auto" }}>
                            We'd love to hear from you! Please reach out using any of the methods below or fill out the contact form.
                        </Typography>
                    </Box>
                                ...
                                <Grid item xs={12} sm={6} md={3} key={index}>
                                    ...
                                    >
                                        <CardContent sx={{ textAlign: "center", p: 3 }}>
                                            ...
                                            <Typography variant="body2" color={darkMode ? "#aaaaaa" : "#666666"} gutterBottom>
                                                {option.description}
                                            </Typography>
